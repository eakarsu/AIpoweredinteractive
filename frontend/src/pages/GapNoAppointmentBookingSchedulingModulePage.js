...
// Gap (Non-AI): No appointment booking/scheduling module
// No appointment booking/scheduling module
import React, { useState } from 'react';

export default function GapNoAppointmentBookingSchedulingModulePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-appointment-booking-scheduling-module/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No appointment booking/scheduling module</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No appointment booking/scheduling module</p>
