...
// Computer vision damage assessment: Photo of vehicle damage (dent, paint scratch, window crack); AI assesses severity, estimates repair cost, recommends body shops
import React, { useState } from 'react';

export default function CFComputerVisionDamageAssessmentPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-computer-vision-damage-assessment/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Computer vision damage assessment</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Computer vision damage assessment: Photo of vehicle damage (dent, paint scratch, window crack); AI assesses severity, estimates repair cost, recommends body shops</p>
